...
st.markdown('<i style="color:red;">Toto je pracovní verze. '+'\n'+
            'Data krom budoucího růstu jsou z oec.world. Projekce 2025-30 berte s velikou rezervou.</i>', unsafe_allow_html=True)
